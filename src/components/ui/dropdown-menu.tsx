...
import MaterialChevronRight from '~icons/material-symbols/chevron-right'
import MaterialCircle from '~icons/material-symbols/circle'
    ...
    >
      <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <MaterialCheck className="size-5" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.CheckboxItem>
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <MaterialCircle className="size-2 fill-current" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        'text-muted-foreground opacity-50 ml-auto text-xs tracking-widest',
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <MaterialChevronRight className="ml-auto size-5" />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
