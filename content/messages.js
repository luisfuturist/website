export default {
  "Luis Emidio | Homepage": {
    "pt": "Luis Emidio | Página Inicial"
  },
  "Explore my personal website.": {
    "pt": "Explore o meu site pessoal."
  },
  "Luis Emidio, website, technology, developer": {
    "pt": "Luis Emidio, site, tecnologia, desenvolvedor"
  },
  "Let's connect!": {
  ...
  "I've curated a collection of my favorite content that resonate deeply with me. If you are curious, you can explore it here:": {
    "pt": "Criei uma coleção do meu conteúdo favorito que ressoa profundamente comigo. Se você está curioso, pode explorá-lo aqui:"
  },
  "My YouTube playlists": {
    "pt": "Minhas playlists do YouTube"
  },
  "Contact": {
    "pt": "Contato"
  },
  "If you share similar interests or want to chat about exciting futuristic projects, don't hesitate to reach out. I would love to hear from you!": {
    "pt": "Se você compartilha interesses semelhantes ou quer conversar sobre projetos futuristas empolgantes, não hesite em entrar em contato. Adoraria ouvir de você!"
  },
  "Let's be part of the future together!": {
    "pt": "Vamos fazer parte do futuro juntos!"
  },
  "Something important?": {
    "pt": "Algo importante?"
  },
  "Send me an email at": {
    "pt": "Envie-me um e-mail para"
  },
  "Just want to chat?": {
    "pt": "Só quer conversar?"
  },
  "Send me a message on Discord": {
    "pt": "Envie-me uma mensagem no Discord"
  },
  "Portfolio": {
    "pt": "Portfólio"
  },
  "I'm constantly striving to enhance my skills and learn new things. Feel free to check back in the future to see what I've been working on. Thank you for your interest in my work, and I look forward to sharing more with you soon!": {
    "pt": "Estou constantemente buscando aprimorar minhas habilidades e aprender coisas novas. Sinta-se à vontade para verificar no futuro para ver no que tenho trabalhado. Obrigado pelo seu interesse no meu trabalho, e estou ansioso para compartilhar mais com você em breve!"
  },
  "Recent Repositories": {
    "pt": "Repositórios Recentes"
  },
  "Click on the icons below to visit the respective source code or demo for more details.": {
    "pt": "Clique nos ícones abaixo para visitar o código-fonte ou a demonstração respectivos para mais detalhes."
  },
  "Click on the icons to visit the respective source code or demo for more details.": {
    "pt": "Clique nos ícones para visitar o código-fonte ou a demonstração respectivos para mais detalhes."
  },
  "Explore all my repositories": {
    "pt": "Explore todos os meus repositórios"
  },
  "Access my GitHub Profile": {
    "pt": "Acesse meu Perfil do GitHub"
  },
  "Currently, I'm in the process of building my portfolio. Meanwhile, you can track my progress and explore some of my work on": {
    "pt": "Atualmente, estou no processo de construção do meu portfólio. Enquanto isso, você pode acompanhar meu progresso e explorar alguns dos meus trabalhos em"
  },
  "I learn things fast": {
  ...
  "I think computationally": {
    "pt": "Eu penso de forma computacional"
  },
  "I excel at computational thinking, leveraging analytical skills and innovative approaches to solve complex tech problems.": {
    "pt": "Excelho no pensamento computacional, utilizando habilidades analíticas e abordagens inovadoras para resolver problemas tecnológicos complexos."
  },
  ...
  "I have a passion for delving deep into topics, exploring intricate details and gaining a comprehensive understanding that goes beyond surface-level knowledge. This depth of exploration enables me to uncover valuable insights and innovative solutions.": {
    "pt": "Tenho paixão por aprofundar em temas, explorando detalhes intrincados e adquirindo uma compreensão abrangente que vai além do conhecimento superficial. Essa profundidade de exploração me permite descobrir insights valiosos e soluções inovadoras."
  },
  "Discord copied successfully!": {
    "pt": "Discord copiado com sucesso!"
  },
  "Error copying Discord!": {
    "pt": "Erro ao copiar o Discord!"
  },
  "{year} {separator} Generated by {ai} + {me}": {
    "pt": "{year} {separator} Gerado por {ai} + {me}"
  },
  "AI": {
    "pt": "IA"
  },
